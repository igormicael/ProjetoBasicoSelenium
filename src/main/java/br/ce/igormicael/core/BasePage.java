...
/********* TextField e TextArea ************/
	...
	public boolean verificarOpcaoCombo(String id, String opcao){
		return verificarOpcaoCombo(By.id(id), opcao);
	}
	...
	public void selecionarComboPrime(String radical, String valor) {
		clicarRadio("//*[@id='"+radical+"_input']/../..//span");
		clicarRadio("//*[@id='"+radical+"_items']//li[.='"+valor+"']");
	}
	...
	private int obterIndiceLinha(String valor, WebElement tabela, int idColuna) {
		...
		for (WebElement linha : linhas) {
			...
			if(linha.getText().equalsIgnoreCase(valor)) {
				// soma é necessaria pois no browser os indices começam com 1
				idLinha = linhas.indexOf(linha) + 1;
				break;
			}
		}
	...
	private int obterIndiceColuna(String colunaBusca, WebElement tabela) {
		...
		for (WebElement coluna : colunas) {
			...
			if(coluna.getText().equalsIgnoreCase(colunaBusca)) {
				// soma é necessaria pois no browser os indices começam com 1
				idColuna = colunas.indexOf(coluna) + 1;
				break;
			}
		}
